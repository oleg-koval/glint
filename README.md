...
| 💧 **Hydration** | `💧 47m` | Minutes since your last drink, hidden until 45 of them, firmer (`💧 1h40m drink`) at twice that. Shares the break clock, so getting up resets it; `--drank` covers drinking at your desk |
